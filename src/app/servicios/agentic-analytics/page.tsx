        ...
        <div className="container mx-auto px-6 relative z-20 grid md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col justify-center space-y-6 text-center md:text-left">
            <AnimatedOnScroll animation="fadeInUp">
              <p className="text-sm font-bold text-primary uppercase tracking-widest">Agentic Analytics & Ops</p>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-sora font-extrabold tracking-tight text-foreground">
                Transforma tus Datos en tu Activo más Valioso
              </h1>
            </AnimatedOnScroll>
            <AnimatedOnScroll animation="fadeInUp" delay={200}>
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto md:mx-0">
                Deja de operar con hojas de cálculo y procesos manuales. Nuestros agentes de IA convierten tus datos en decisiones inteligentes y automatizan tus operaciones para una eficiencia radical.
              </p>
            </AnimatedOnScroll>
          ...
          <AnimatedOnScroll animation="zoomIn" delay={300} className="flex justify-center items-center">
            <Image
              src="/analytics_hero.png"
              alt="Ilustración de un agente IA optimizando operaciones y analizando datos"
              width={850}
              height={680}
      ...
      <div className="relative bg-muted overflow-hidden">
        ...
        <section id="problemas" className="py-16 md:py-24 relative z-20">
          <div className="container mx-auto px-6 text-center">
            <AnimatedOnScroll animation="fadeInUp">
              <h2 className="text-3xl md:text-4xl font-sora font-bold mb-4">¿Tus operaciones y datos te frenan?</h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-12">
                Muchas empresas tienen una mina de oro en sus datos, pero no tienen las herramientas para explotarla y sus procesos son un lastre.
              </p>
            </AnimatedOnScroll>
              ...
              <AnimatedOnScroll animation="fadeInUp" delay={100}>
                <div className="bg-card/80 backdrop-blur-sm p-0 rounded-xl border border-border text-left overflow-hidden h-full flex flex-col">
                  <Image
                    ...
                    alt="Datos que no informan"
                    width={400}
                    height={150}
                    className="w-full h-auto object-cover rounded-t-xl"
                    data-ai-hint="data dashboards not actionable analytics"
                  />
                  <div className="p-8 flex-grow">
                    <h3 className="text-xl font-sora font-bold mb-3">Datos que no Informan</h3>
                    <p className="text-muted-foreground">
                      Tienes dashboards y reportes, pero no te dicen qué hacer a continuación. La información no se traduce en acciones claras.
                    </p>
                  </div>
                </div>
              </AnimatedOnScroll>
              <AnimatedOnScroll animation="fadeInUp" delay={200}>
                <div className="bg-card/80 backdrop-blur-sm p-0 rounded-xl border border-border text-left overflow-hidden h-full flex flex-col">
                  <Image
                    ...
                    alt="Operaciones ineficientes"
                    width={400}
                    height={150}
                    className="w-full h-auto object-cover rounded-t-xl"
                    data-ai-hint="inefficient manual operations processes"
                  />
                  <div className="p-8 flex-grow">
                    <h3 className="text-xl font-sora font-bold mb-3">Operaciones Ineficientes</h3>
                    <p className="text-muted-foreground">
                      Procesos como la gestión de inventario, cobranza o logística dependen de trabajo manual, propenso a errores y lento.
                    </p>
                  </div>
                </div>
              </AnimatedOnScroll>
              <AnimatedOnScroll animation="fadeInUp" delay={300}>
                <div className="bg-card/80 backdrop-blur-sm p-0 rounded-xl border border-border text-left overflow-hidden h-full flex flex-col">
                  <Image
                    ...
                    alt="Pérdida de oportunidades"
                    width={400}
                    height={150}
                    className="w-full h-auto object-cover rounded-t-xl"
                    data-ai-hint="missed opportunities market timing analytics"
                  />
                  <div className="p-8 flex-grow">
                    <h3 className="text-xl font-sora font-bold mb-3">Pérdida de Oportunidades</h3>
                    <p className="text-muted-foreground">
                      No puedes reaccionar a tiempo a cambios en el mercado, ajustar precios dinámicamente o predecir la demanda.
                    </p>
                  </div>
                </div>
              </AnimatedOnScroll>
        ...
        <section id="solucion" className="py-16 md:py-24 relative z-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12 md:mb-16">
              <AnimatedOnScroll animation="fadeInUp">
                <p className="text-sm font-bold text-primary uppercase tracking-widest">La Solución Agentic Analytics & Ops</p>
                <h2 className="text-3xl md:text-4xl font-sora font-bold mt-2">El Cerebro Operativo de tu Negocio</h2>
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto mt-4">
                  Nuestros agentes se conectan a tus fuentes de datos y sistemas de gestión para interpretar, decidir y ejecutar tareas operativas complejas.
                </p>
              </AnimatedOnScroll>
            </div>
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 items-center">
              <div className="space-y-8">
                <AnimatedOnScroll animation="fadeInUp" delay={100}>
                  <div>
                    <h3 className="font-sora text-xl font-bold mb-2">Análisis de Datos en Tiempo Real</h3>
                    <p className="text-muted-foreground">
                      Agentes que no solo muestran datos, sino que los interpretan, identifican anomalías y te entregan insights accionables en lenguaje natural.
                    </p>
                  </div>
                </AnimatedOnScroll>
                <AnimatedOnScroll animation="fadeInUp" delay={200}>
                  <div>
                    <h3 className="font-sora text-xl font-bold mb-2">Gestión de Inventarios Inteligente</h3>
                    <p className="text-muted-foreground">
                      Predice la demanda, sugiere puntos de reorden y automatiza la compra de stock para evitar quiebres o excesos de inventario.
                    </p>
                  </div>
                </AnimatedOnScroll>
                <AnimatedOnScroll animation="fadeInUp" delay={300}>
                  <div>
                    <h3 className="font-sora text-xl font-bold mb-2">Automatización de Procesos Críticos</h3>
                    <p className="text-muted-foreground">
                      Desde la compra de guías de envío hasta la gestión de cobranza y el ajuste dinámico de precios, nuestros agentes ejecutan tareas que consumen el tiempo de tu equipo.
                    </p>
                  </div>
                </AnimatedOnScroll>
                <AnimatedOnScroll animation="fadeInUp" delay={400}>
                  <div>
                    <h3 className="font-sora text-xl font-bold mb-2">Optimización a Medida</h3>
                    <p className="text-muted-foreground">
                      Diseñamos agentes para resolver cualquier reto operativo único de tu empresa, sin importar la complejidad.
                    </p>
                  </div>
                </AnimatedOnScroll>
              </div>
              <AnimatedOnScroll animation="zoomIn" delay={200} className="flex justify-center">
                <Image
                  src="/analytics_hero.png"
                  alt="Diagrama de flujo de Agentic Analytics & Ops"
                  width={719}
                  height={575}
        ...
        <section className="py-16 md:py-24 relative z-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <AnimatedOnScroll animation="fadeInUp">
                <h2 className="text-3xl md:text-4xl font-sora font-bold">Convierte tus Operaciones en una Ventaja Competitiva</h2>
              </AnimatedOnScroll>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <AnimatedOnScroll animation="fadeInUp" delay={100}>
                <div className="text-center">
                  ...
                  <h3 className="font-sora text-xl font-bold mb-2">Decisiones más Inteligentes</h3>
                  <p className="text-muted-foreground">
                    Pasa de reaccionar a predecir. Toma decisiones estratégicas sobre precios, inventario y más, basadas en análisis predictivos.
                  </p>
                </div>
              </AnimatedOnScroll>
              <AnimatedOnScroll animation="fadeInUp" delay={200}>
                <div className="text-center">
                  ...
                  <h3 className="font-sora text-xl font-bold mb-2">Eficiencia Operativa Radical</h3>
                  <p className="text-muted-foreground">
                    Reduce costos y errores humanos al automatizar tareas repetitivas y complejas, liberando a tu equipo para el trabajo de alto valor.
                  </p>
                </div>
              </AnimatedOnScroll>
              <AnimatedOnScroll animation="fadeInUp" delay={300}>
                <div className="text-center">
                  ...
                  <h3 className="font-sora text-xl font-bold mb-2">Maximiza la Rentabilidad</h3>
                  <p className="text-muted-foreground">
                    Optimiza precios, reduce costos de inventario y mejora la cobranza para impactar directamente en tu línea de fondo.
                  </p>
                </div>
              </AnimatedOnScroll>
            </div>
        ...
        <section className="py-16 md:py-24 relative z-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <AnimatedOnScroll animation="fadeInUp">
                <h2 className="text-3xl md:text-4xl font-sora font-bold mb-4">Nos Integramos con tus Sistemas de Datos</h2>
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Nuestros agentes se conectan con las plataformas que ya utilizas, desde tu analytics, herramientas de visualización, automatización y sistemas CRM.
                </p>
              </AnimatedOnScroll>
            </div>
            <AnimatedOnScroll animation="fadeInUp" delay={200}>
              ...
              <div className="mt-12 bg-card/80 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-xl max-w-4xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="text-center md:text-left">
                    <p className="text-7xl font-black text-primary">-23%</p>
                    <p className="text-2xl font-sora font-bold mt-2">Reducción de Costos Operativos</p>
                    <p className="text-muted-foreground mt-2">
                      Es la reducción promedio en costos operativos que logran nuestros clientes en los primeros 6 meses.
                    </p>
                  </div>
                  <div className="bg-background/50 backdrop-blur-sm p-6 rounded-lg">
                    <p className="text-foreground italic mb-4">
                      "La gestión de inventario y la cobranza nos consumían. Los agentes de Aijolot no solo automatizaron el proceso, sino que lo hicieron más inteligente. Ahora tenemos menos errores y más flujo de caja."
                    </p>
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-bold">Ana Aguilar</p>
                        <p className="text-sm text-muted-foreground">Gerente de Operaciones, ModaRetail</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto">
              <AnimatedOnScroll animation="fadeInUp">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-sora font-bold mb-6">
                  ¿Listo para operar a la velocidad de la IA?
                </h2>
                <p className="text-lg text-muted-foreground mb-8">
                  Agenda una demo y te mostraremos cómo nuestros agentes de IA pueden conectarse a tus sistemas, analizar tus datos y automatizar tus procesos para llevar tu eficiencia a un nuevo nivel.
                </p>
              </AnimatedOnScroll>
              <AnimatedOnScroll animation="fadeInUp" delay={200}>
                <Button asChild size="lg" className="rounded-lg text-base font-bold transition-transform hover:scale-105 h-14 px-8 bg-primary hover:bg-primary/90 text-primary-foreground shine-button">
                  <Link href="/contact">
                    Agendar Demo de Agentic Analytics & Ops
                  </Link>
                </Button>
              </AnimatedOnScroll>
            </div>
